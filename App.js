...
function App() {
  ...
  const handleEdit = (id) => {
    ...
    // Set the fields to the original person's data and mark them as readOnly
    setPerson({
      ...personToEdit,
      number: personToEdit.number, // Set to original value
      email: personToEdit.email, // Set to original value
    });
    setEditingId(id);
  };
    ...
    <div className="App">
      ...
      >
        ...
        <div className="form-group">
          ...
          {editingId !== null ? ( // Check if editing
            <input
              type="text"
              id="number"
              name="number"
